...
local dialog_content=vb:column{
  ...
  vb:row{
    spacing=5,
    vb:button{text="PayPal.me",notifier=function() renoise.app():open_url("https://www.paypal.com/paypalme/esaruoho") end},
    vb:button{text="Ko-Fi",notifier=function() renoise.app():open_url("https://ko-fi.com/esaruoho") end},
    vb:button{text="Bandcamp",notifier=function() renoise.app():open_url("http://lackluster.bandcamp.com/") end},
    vb:button{text="Gumroad",notifier=function() renoise.app():open_url("https://lackluster.gumroad.com/l/paketti") end}
  }
}
...
renoise.tool():add_menu_entry{name="--Main Menu:Tools:Paketti..:!!About..:About Paketti...",invoke=function() show_about_dialog() end}
  ...
  local dialog_content = vb:column{margin=10,
    vb:column{style="group",margin=5,
      vb:row{
        ...
        vb:button{text="Resample", width=50, notifier=function()
        PakettiResamplerDialogShow() end},
