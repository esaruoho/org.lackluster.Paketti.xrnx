...
local dialog_title = "Paketti 0.13 - Pattern Effect Command CheatSheet"
...
if renoise.song().selected_note_column then renoise.song().selected_note_column.delay_value=v1 end end},
...
if renoise.song().selected_note_column then renoise.song().selected_note_column.panning_value=v2 end end},
...
if renoise.song().selected_note_column then renoise.song().selected_note_column.volume_value=v3 end end},
